<template>
  <div class="mt-16 w-full flex items-center flex-col">
    <!-- TODO: add to this component ability to toggle into merchant sign in -->
    <div class="container max-w-md mx-auto flex flex-col px-2">
      <div class="bg-white px-6 py-4 rounded shadow-md text-black w-full">
        <h1 class="tracking-wide pb-6 text-center text-gray-800">Sign in</h1>
