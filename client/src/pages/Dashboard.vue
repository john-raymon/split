...
.virtual-debit-card-container {
  @apply relative w-full bg-gray-900 rounded-lg text-gray-200;
  padding-bottom: 60%;
  &__contents {
...
.card-controls {
  @apply w-full -mt-4 pt-4 px-4 bg-gray-200 rounded-bl-lg rounded-br-lg;
}
</style>
